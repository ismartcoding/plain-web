<template>
  <section v-if="!isPhone" class="app-item selectable-card-skeleton">
  ...
  <SkeletonItemPhone v-else title-width="70%" :subtitles="[{ width: '45%' }, { width: '30%' }, { width: '40%' }, { width: '40%' }]" :action-count="2" />
</template>
