import type { PresetInfo, PresetResult, NavigatorUABrandVersion } from './types'
...
export function findBrand(brands: NavigatorUABrandVersion[], preset: PresetInfo): NavigatorUABrandVersion | undefined {
  return brands.find((it) => execRegExp(`${preset.test}`, it.brand.toLowerCase()))
}
