export default {
  ...
  type: 'Тип',
  time: 'Время',
  no_permission: 'Нет разрешения. Пожалуйста, перейдите в раздел APP > "Настройки доступа", чтобы предоставить разрешения и обновите страницу.',
  notification_listener_permission_denied: "Доступ к уведомлениям не включён на этом устройстве.",
  check_phone: 'Пожалуйста, проверьте телефон.',
  open_access_settings: 'Открыть настройки доступа',
  no_data: 'Нет данных',
  ...
  md_inline_code: 'Встроенный код',
  md_link: 'Ссылка',
  open_image: 'Открыть изображение',
  copy_image_link: 'Копировать ссылку на изображение',
  copy_code: 'Копировать код',
  md_h2: 'Заголовок 2',
  md_h3: 'Заголовок 3',
  md_ul: 'Маркированный список',
  md_ol: 'Нумерованный список',
  md_task: 'Список задач',
  md_quote: 'Цитата',
  md_code: 'Блок кода',
  md_table: 'Таблица',
  md_hr: 'Разделитель',
  ...
  desktop_access_disabled: 'Доступ с компьютера отключен. Пожалуйста, откройте PlainApp на телефоне и включите "Службу PlainApp".',
  ...
  customize_ui: 'Настроить интерфейс',
  customize_ui_tab_sidebar: 'Боковая панель',
  customize_ui_tab_home: 'Главная',
