export default {
  ...
  md_italic: '斜體',
  md_strike: '刪除線',
  md_inline_code: '行內程式碼',
  md_link: '連結',
  open_image: '檢視圖片',
  copy_image_link: '複製圖片連結',
  copy_code: '複製程式碼',
  md_h2: '標題 2',
  md_h3: '標題 3',
  md_ul: '無序清單',
  ...
  desktop_access_disabled: '電腦存取功能已關閉。請在手機上開啟 PlainApp，並開啟「PlainApp 服務」。',
  select_first: '請先選擇！',
  clear_list: '清空清單',
  tools: '工具',
  json_viewer: 'JSON檢視器',
