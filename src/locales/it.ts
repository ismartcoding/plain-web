export default {
  ...
  compress_quality: 'Qualità compressa',
  mirror_quality: 'Qualità dello specchio',
  resolution: 'Risoluzione',
  screen_mirror_quality_tips: 'Più piccolo è il valore della qualità di compressione, più bassa è la qualità. Optare per impostazioni di qualità più elevate può causare una duplicazione dello schermo più lenta e possibili ritardi.',
