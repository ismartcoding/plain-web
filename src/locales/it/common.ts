export default {
  ...
  page_title: {
    ...
    developer: 'Modalità sviluppatore',
    image_editor: 'Editor di immagini',
  },
  online: 'Audio',
  offline: 'E-mail',
  unknown: 'Sconosciuto',
  ...
  md_italic: 'Corsivo',
  md_strike: 'Barrato',
  md_inline_code: 'Codice in linea',
  md_link: 'Collegamento',
  open_image: 'Apri immagine',
  copy_image_link: 'Copia link immagine',
  copy_code: 'Copia codice',
  md_h2: 'Titolo 2',
  md_h3: 'Titolo 3',
  md_ul: 'Elenco puntato',
  md_ol: 'Elenco numerato',
  md_task: 'Elenco attività',
  md_quote: 'Citazione',
  md_code: 'Blocco di codice',
  md_table: 'Tabella',
  md_hr: 'Separatore',
  md_image: 'Immagine',
  ...
  desktop_access_disabled: 'L\'accesso desktop è disattivato. Apri PlainApp sul tuo telefono e attiva il "Servizio PlainApp".',
  ...
  customize_ui: 'Personalizza UI',
  customize_ui_tab_sidebar: 'Barra laterale',
