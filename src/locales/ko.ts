export default {
  ...
  release_to_send_file: '파일을 전송하려면 놓으세요',
  confirm_to_delete_name: '"{name}"을(를) 삭제하시겠습니까?',
  confirm_to_delete: '삭제하시겠습니까?',
  valid: {
  ...
  description: '설명',
  notes: '노트',
  rule_inbound: '{action} {target}에서의 트래픽',
  rule_outbound: '{action} {target}으로의 트래픽',
  for_example: '예시',
  invalid_value: '잘못된 값',
  space: ' ',
  ...
  path: '경로',
  open: '열기',
  box_is_null: '앱에서 상자를 선택한 후 다시 시도하십시오.',
  ...
  no_content: '[콘텐츠 없음]',
  confirm: '확인',
  upload_audios: '음악 폴더 또는 다른 폴더에 업로드할 수 있습니다.',
  upload_videos: '비디오 폴더 또는 다른 폴더에 업로드할 수 있습니다.',
  upload_images: '이미지 폴더 또는 다른 폴더에 업로드할 수 있습니다.',
  no_files: '파일 없음',
  ...
  view_as_list: '목록으로 보기',
  view_as_grid: '그리드로 보기',
  pause: '일시 정지',
  playlist: '재생 목록',
  no_api_key: 'API 키 없음',
  refresh: '새로 고침',
