export default {
  ...
  quality_sd: 'SD',
  quality_ld: 'LD',
  change_quality: 'Изменить качество',
  compress_quality: 'Сжать качество',
  mirror_quality: 'Качество зеркала',
  resolution: 'Разрешение',
  screen_mirror_quality_tips: 'Чем меньше значение качества сжатия, тем ниже качество. Выбор более высоких настроек качества может привести к замедлению зеркального отображения экрана и возможным задержкам.',
