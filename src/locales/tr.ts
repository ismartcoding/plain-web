export default {
  ...
  quality_sd: 'SD',
  quality_ld: 'LD',
  change_quality: 'Kaliteyi değiştir',
  compress_quality: 'Kaliteyi sıkıştır',
  mirror_quality: 'Yansıma kalitesi',
  resolution: 'Çözünürlük',
  screen_mirror_quality_tips: 'Sıkıştırma kalitesi değeri ne kadar küçük olursa, kalite o kadar düşük olur. Daha yüksek kalite ayarlarını seçmek, daha yavaş bir ekran yansıtma ve olası gecikmelere neden olabilir.',
