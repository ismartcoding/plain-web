export default {
  ...
  page_title: {
    ...
    developer: 'डेवलपर मोड',
    image_editor: 'छवि संपादक',
  },
  online: 'ऑनलाइन',
  offline: 'ऑफलाइन',
  unknown: 'अननोन',
  ...
  md_bold: 'बोल्ड',
  md_italic: 'इटैलिक',
  md_strike: 'स्ट्राइकथ्रू',
  md_inline_code: 'इनलाइन कोड',
  md_link: 'लिंक',
  open_image: 'छवि खोलें',
  copy_image_link: 'छवि लिंक कॉपी करें',
  copy_code: 'कोड कॉपी करें',
  md_h2: 'शीर्षक 2',
  md_h3: 'शीर्षक 3',
  md_ul: 'बुलेट सूची',
  md_ol: 'क्रमांकित सूची',
  md_task: 'कार्य सूची',
  md_quote: 'उद्धरण',
  md_code: 'कोड ब्लॉक',
  md_table: 'तालिका',
  ...
  desktop_access_disabled: 'डेस्कटॉप एक्सेस बंद है। कृपया अपने फोन पर PlainApp खोलें और "PlainApp सेवा" चालू करें।',
  ...
  developer: {
    ...
    clear_logs: 'लॉग्स साफ़ करें',
    key: 'कुंजी',
    value: 'मान',
    db_row_count: '{count} पंक्तियाँ',
  },
}
