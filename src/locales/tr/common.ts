export default {
  ...
  page_title: {
    ...
    developer: 'Geliştirici Modu',
    image_editor: 'Görsel düzenleyici',
  },
  online: 'Çevrimiçi',
  offline: 'Çevrimdışı',
  unknown: 'Bilinmiyor',
  ...
  md_bold: 'Kalın',
  md_italic: 'İtalik',
  md_strike: 'Üstü çizili',
  md_inline_code: 'Satır içi kod',
  md_link: 'Bağlantı',
  open_image: 'Görseli aç',
  copy_image_link: 'Görsel bağlantısını kopyala',
  copy_code: 'Kodu kopyala',
  md_h2: 'Başlık 2',
  md_h3: 'Başlık 3',
  md_ul: 'Madde işaretli liste',
  md_ol: 'Numaralı liste',
  md_task: 'Yapılacaklar listesi',
  md_quote: 'Alıntı',
  md_code: 'Kod bloğu',
  md_table: 'Tablo',
  md_hr: 'Ayırıcı',
  ...
  desktop_access_disabled: 'Masaüstü erişimi kapalı. Lütfen telefonunuzda PlainApp\'i açın ve "PlainApp Hizmeti"ni etkinleştirin.',
