export default {
  ...
  md_italic: 'Italique',
  md_strike: 'Barré',
  md_inline_code: 'Code en ligne',
  md_link: 'Lien',
  open_image: 'Ouvrir l’image',
  copy_image_link: 'Copier le lien de l’image',
  copy_code: 'Copier le code',
  md_h2: 'Titre 2',
  md_h3: 'Titre 3',
  md_ul: 'Liste à puces',
  md_ol: 'Liste numérotée',
  md_task: 'Liste de tâches',
  md_quote: 'Citation',
  md_code: 'Bloc de code',
  md_table: 'Tableau',
  md_hr: 'Séparateur',
  md_image: 'Image',
  ...
  desktop_access_disabled: 'L\'accès bureau est désactivé. Veuillez ouvrir PlainApp sur votre téléphone et activer le "Service PlainApp".',
