export default {
  ...
  release_to_send_file: 'Nhả để gửi tệp',
  confirm_to_delete_name: 'Xác nhận xóa "{name}"?',
  confirm_to_delete: 'Xác nhận xóa?',
  valid: {
  ...
  description: 'Mô tả',
  notes: 'Ghi chú',
  rule_inbound: '{action} lưu lượng từ {target}',
  rule_outbound: '{action} lưu lượng đến {target}',
  for_example: 'ví dụ',
  invalid_value: 'Giá trị không hợp lệ',
  space: ' ',
  remote_port: 'cổng từ xa {port}',
  all_local_networks: 'Tất cả các mạng cục bộ',
  ...
  examples_remote_port: 'Ví dụ\n1419\n1001–1024',
  route_description: 'Chuyển hướng lưu lượng đến {target} qua {if_name}',
  traffic_to: 'Lưu lượng đến',
  route_via: 'Đường đi tới',
  ...
  path: 'Đường dẫn',
  open: 'Mở',
  box_is_null: 'Vui lòng chọn một hộp trong ứng dụng và thử lại',
  ...
  confirm: 'Xác nhận',
  upload_audios: 'Bạn có thể tải lên trong thư mục Âm nhạc hoặc thư mục khác.',
  upload_videos: 'Bạn có thể tải lên trong thư mục Video hoặc thư mục khác.',
  upload_images: 'Bạn có thể tải lên trong thư mục Hình ảnh hoặc thư mục khác.',
  ...
  view_as_list: 'Xem dạng danh sách',
  view_as_grid: 'Xem dạng lưới',
  pause: 'Tạm dừng',
