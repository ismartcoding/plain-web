export default {
  ...
  quality_sd: 'SD',
  quality_ld: 'LD',
  change_quality: 'Thay đổi chất lượng',
  compress_quality: 'Nén chất lượng',
  mirror_quality: 'Chất lượng phản chiếu',
  resolution: 'Độ phân giải',
  screen_mirror_quality_tips: 'Càng nhỏ giá trị chất lượng nén, chất lượng càng thấp. Chọn các thiết lập chất lượng cao hơn có thể dẫn đến việc phản chiếu màn hình chậm hơn và có thể gây trễ.',
