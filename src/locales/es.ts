export default {
  ...
  compress_quality: 'Comprimir calidad',
  mirror_quality: 'Calidad del espejo',
  resolution: 'Resolución',
  screen_mirror_quality_tips: 'Cuanto menor sea el valor de calidad de compresión, menor será la calidad. Optar por ajustes de calidad más altos puede resultar en una espejo de pantalla más lento y posibles retrasos.',
