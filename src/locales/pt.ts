export default {
  ...
  types: 'Tipos',
  view_as_table: 'Visualizar como tabela',
  ...
  release_to_send_file: 'Solte para enviar arquivo',
  ...
  view_as_list: 'Visualizar como lista',
  view_as_grid: 'Visualizar como grade',
  pause: 'Pausar',
