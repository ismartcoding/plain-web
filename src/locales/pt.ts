export default {
  ...
  quality_sd: 'SD',
  quality_ld: 'LD',
  change_quality: 'Alterar qualidade',
  compress_quality: 'Comprimir qualidade',
  mirror_quality: 'Qualidade do espelhamento',
  resolution: 'Resolução',
  screen_mirror_quality_tips: 'Quanto menor o valor da qualidade de compressão, menor a qualidade. Optar por configurações de qualidade mais alta pode resultar em espelhamento de tela mais lento e possíveis atrasos.',
