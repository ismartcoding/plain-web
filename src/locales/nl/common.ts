export default {
  ...
  md_bold: 'Vet',
  md_italic: 'Cursief',
  md_strike: 'Doorgehaald',
  md_inline_code: 'Inline code',
  md_link: 'Koppeling',
  open_image: 'Afbeelding openen',
  copy_image_link: 'Afbeeldingslink kopiëren',
  copy_code: 'Code kopiëren',
  md_h2: 'Koptekst 2',
  md_h3: 'Koptekst 3',
  md_ul: 'Opsomming',
  md_ol: 'Genummerde lijst',
  md_task: 'Takenlijst',
  md_quote: 'Citaat',
  md_code: 'Codeblok',
  md_table: 'Tabel',
  md_hr: 'Scheidingslijn',
  md_image: 'Afbeelding',
  uploading: 'Uploaden...',
  view: 'Bekijken',
  copy: 'Kopiëren',
  ...
  desktop_access_disabled: 'Desktoptoegang is uitgeschakeld. Open PlainApp op je telefoon en schakel de "PlainApp-service" in.',
