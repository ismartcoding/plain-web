export default {
  ...
  page_title: {
    ...
    developer: 'Chế độ nhà phát triển',
  ...
  md_h1: 'Tiêu đề 1',
  md_bold: 'In đậm',
  md_italic: 'In nghiêng',
  md_strike: 'Gạch ngang',
  md_inline_code: 'Code nội dòng',
  md_link: 'Liên kết',
  open_image: 'Mở hình ảnh',
  copy_image_link: 'Sao chép liên kết ảnh',
  copy_code: 'Sao chép mã',
  md_h2: 'Tiêu đề 2',
  md_h3: 'Tiêu đề 3',
  md_ul: 'Danh sách đánh dấu',
  md_ol: 'Danh sách đánh số',
  md_task: 'Danh sách việc cần làm',
  md_quote: 'Trích dẫn',
  md_code: 'Khối mã',
  md_table: 'Bảng',
  md_hr: 'Đường phân cách',
  md_image: 'Hình ảnh',
  ...
  desktop_access_disabled: 'Truy cập máy tính đang tắt. Vui lòng mở PlainApp trên điện thoại của bạn và bật "Dịch vụ PlainApp".',
