export default {
  ...
  screen_mirror_request_permission:
    'Veuillez appuyer sur "Commencer maintenant" sur votre téléphone.<br>Si la fenêtre de permission n\'apparaît pas, rouvrez PlainApp.<br>Réessayez dans {seconds} secondes.',
}
