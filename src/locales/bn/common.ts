export default {
  ...
  md_bold: 'বোল্ড',
  md_italic: 'ইটালিক',
  md_strike: 'স্ট্রাইকথ্রু',
  md_inline_code: 'ইনলাইন কোড',
  md_link: 'লিংক',
  open_image: 'ছবি খুলুন',
  copy_image_link: 'ছবির লিংক কপি করুন',
  copy_code: 'কোড কপি করুন',
  md_h2: 'শিরোনাম ২',
  md_h3: 'শিরোনাম ৩',
  md_ul: 'বুলেট তালিকা',
  md_ol: 'সংখ্যাযুক্ত তালিকা',
  md_task: 'টু-ডু তালিকা',
  md_quote: 'উদ্ধৃতি',
  md_code: 'কোড ব্লক',
  md_table: 'টেবিল',
  md_hr: 'বিভাজক',
  ...
  desktop_access_disabled: 'ডেস্কটপ অ্যাক্সেস বন্ধ আছে। দয়া করে আপনার ফোনে PlainApp খুলুন এবং "PlainApp সার্ভিস" চালু করুন।',
