<template>
  ...
  >
    ...
    <div class="image">
      ...
      <img v-else class="image-thumb" :src="getFileUrl(item.fileId, '&w=512&h=512')" loading="lazy" @error="onImageError(item.id)" />
    </div>
...
import type { IVideoItem, IBucket, IFilter, ITag } from '@/lib/interfaces'
