    ...
    <div class="card phone-card">
      <div class="card-content">
        ...
        <div class="phone-input-row">
          <outlined-text-field v-model="callNumber" type="tel" :label="$t('phone_number')" class="phone-input" :error="callNumberError" :error-text="$t('valid.required')" @keyup.enter="callPhone">
          ...
          <filled-button class="call-btn" :disabled="callLoading" @click.prevent="callPhone">
            {{ $t('call') }}
          </filled-button>
        </div>
      </div>
