<template>
  <div class="top-app-bar">
    ...
    <div class="actions">
      <outlined-button class="btn-sm" @click.prevent="toggle(true)">{{ $t('expand_all') }}</outlined-button>
      <outlined-button class="btn-sm" @click.prevent="toggle(false)">{{ $t('collapse_all') }}</outlined-button>
    </div>
  </div>
